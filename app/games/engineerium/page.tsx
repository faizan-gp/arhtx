...
export const metadata: Metadata = {
  title: "Engineerium at Zero Latency Houston | Family-Friendly Free-Roam VR",
  description: "Engineerium at Zero Latency Houston is a no-combat free-roam VR adventure for 1–8 players aged 10 and up. Explore floating worlds and giant sky creatures in a 20-minute session in Houston, Texas.",
  alternates: { canonical: "https://zerolatencyhouston.com/games/engineerium" },
  openGraph: {
    title: "Engineerium at Zero Latency Houston",
    description: "Engineerium at Zero Latency Houston is a family-friendly free-roam VR game for ages 10+. Explore a world of colossal flying whales and floating platforms in 20 minutes in Houston, Texas.",
    url: "https://zerolatencyhouston.com/games/engineerium",
    images: [{ url: "https://zerolatencyhouston.com/game-engineerium.webp", width: 1200, height: 630, alt: "Engineerium family-friendly VR adventure at Zero Latency Houston" }],
  },
};
...
const gameSchema = {
  ...
  "@type": "VideoGame",
  "name": "Engineerium",
  "description": "Engineerium is a no-combat free-roam VR adventure at Zero Latency Houston for 1–8 players aged 10 and older. Players walk through a world of colossal flying whales, floating platforms, and geometric structures in a 20-minute low-intensity session in Houston, Texas.",
...
const breadcrumb = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 3, "item": { "name": "Engineerium", "id": "https://zerolatencyhouston.com/games/engineerium" } },
  ],
};
...
const FEATURES = [
  { img: "/engineerium-scenery.webp", title: "Large-Scale Environments", desc: "Players walk through environments that include colossal flying whales, floating geometric platforms, and sky structures that extend further than any physical space. The free-roam VR arena at Zero Latency Houston makes these spaces feel physically real." },
  ...
  return (
    <>
      ...
      <section className="relative min-h-[80vh] flex items-end pb-16">
        <Image src="/engineerium-hero-bg.webp" alt="Engineerium — family-friendly VR adventure at Zero Latency Houston" fill sizes="100vw" className="object-cover" priority />
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 w-full">
          ...
          <p className="mt-4 text-lg text-[#7DD3FC] max-w-xl">Zero Latency Houston's family-friendly free-roam VR game. No combat, no enemies. 1–8 players aged 10 and up walk through a world of flying whales and floating platforms in 20 minutes.</p>
      ...
      <section className="relative overflow-hidden py-14 mx-4 sm:mx-6 mb-12 rounded-2xl">
        ...
        <div className="relative z-10 text-center px-4 max-w-2xl mx-auto">
          ...
          <h2 className="font-orbitron text-2xl md:text-3xl font-black text-white mb-3">
            Book Engineerium at <span className="text-emerald-400">Zero Latency Houston</span>
          </h2>
