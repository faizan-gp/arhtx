  ...
  return (
    <>
      ...
      <section className="relative min-h-[80vh] flex items-end pb-16">
        <Image src="/undead-hero-bg.webp" alt="Undead Arena zombie VR at Zero Latency Houston" fill sizes="100vw" className="object-cover" priority />
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 w-full">
          ...
          <p className="mt-4 text-lg text-[#7DD3FC] max-w-xl">Zero Latency Houston's zombie wave survival free-roam VR game. 2–8 players fight escalating hordes in a multi-level arena for 30 minutes. Ages 13 and up in Houston, Texas.</p>
          ...
          <div className="grid lg:grid-cols-[1fr_320px] gap-12 items-start">
            <div>
              ...
              <div className="space-y-4 text-[#7DD3FC] leading-relaxed text-sm">
                <p>Undead Arena at Zero Latency Houston is a free-roam VR zombie wave survival game for 2–8 players aged 13 and older. Unlike Outbreak — which has a linear mission structure — Undead Arena uses a single dedicated combat stage in Houston, Texas, and tests how many escalating waves of zombies your squad can survive across a 30-minute session. Players move freely through the arena using the same free-roam VR tracking system that runs all Zero Latency Houston games.</p>
      ...
      <section className="relative overflow-hidden py-14 mx-4 sm:mx-6 mb-12 rounded-2xl">
        ...
        <div className="relative z-10 text-center px-4 max-w-2xl mx-auto">
          ...
          <h2 className="font-orbitron text-2xl md:text-3xl font-black text-white mb-3">Book Undead Arena at <span className="text-lime-400">Zero Latency Houston</span></h2>
